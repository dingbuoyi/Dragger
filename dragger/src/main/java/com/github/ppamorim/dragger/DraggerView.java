...
public class DraggerView extends FrameLayout {
    ...
    private android.support.v4.widget.ViewDragHelper dragHelper;
    ...
    private void initializeAttributes(AttributeSet attrs) {
        ...
        this.runAnimationOnFinishInflate = attributes.getBoolean(R.styleable.dragger_layout_run_animation_on_finish_inflate, false);
    }
    ...
    private void configDragViewHelper() {
        dragHelper = android.support.v4.widget.ViewDragHelper.create(this, SENSITIVITY,
